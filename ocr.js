var ocrDemo = {
	...
	{
	    alert("Pleas type and draw a digit value in order to train the network");
	    return;
	}

	// input data to training data set
	...
	{
	    alert("Pleas draw a digit in order to test the network");
	    return;
	}
